...
<el-row>
				<el-col :span="12">
			<el-form-item  label-width="100px" label="送学时刻:">
				<el-input v-model="postForm.name" autosize placeholder="姓名" />

			</el-form-item>
			</el-col>
			<el-col :span="12">
			<el-form-item  label-width="100px" label="接学时刻">
				<el-input v-model="postForm.teacher" autosize placeholder="电话" />
			...
			<el-form-item  label-width="100px" label="邮箱:">
				...
				<el-input v-model="postForm.email" autosize placeholder="密码:" />

			</el-form-item>
				<el-form-item  label-width="100px" label="密码确认:">
				<el-input v-model="postForm.email" autosize placeholder="密码确认::" />
